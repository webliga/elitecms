...
class M_menu_main extends Model
{
    ...
    {
        $join = 'LEFT JOIN modules ON modules.id = menu.id_module';

        $fildsSelect = 'menu.*, modules.name as name_menu';
        
        $data = $this->selectAllByIdFromTable('menu', $id, $fildsSelect, $join, 'id_module');
        return $data;
    }
